...
struct EmotionDataProvider {
    ...
    static let highEnergyEmotions: [Emotion] = [
        ...
        Emotion(name: "Furious",
                color: ColorData.calculateMoodColor(pleasantness: 0.07, intensity: 0.92) ?? .gray,
                description: "Seething with intense anger, on the brink of eruption, feeling wronged and powerfully hostile.",
                pleasantness: 0.07, intensity: 0.92, control: 0.15, clarity: 0.88),
        ...
        Emotion(name: "Vengeful",
                color: ColorData.calculateMoodColor(pleasantness: 0.12, intensity: 0.82) ?? .gray,
                description: "Driven by a burning desire for retribution, focused on settling a score or righting a wrong.",
                pleasantness: 0.12, intensity: 0.82, control: 0.6, clarity: 0.9),
        ...
        Emotion(name: "Jealous",
                color: ColorData.calculateMoodColor(pleasantness: 0.22, intensity: 0.75) ?? .gray,
                description: "Feeling resentful and bitter over someone's advantages, achievements, or possessions.",
                pleasantness: 0.22, intensity: 0.75, control: 0.35, clarity: 0.6),
        ...
        Emotion(name: "Agitated",
                color: ColorData.calculateMoodColor(pleasantness: 0.28, intensity: 0.88) ?? .gray,
                description: "Restless and troubled, a nervous energy makes it impossible to relax or stay still.",
                pleasantness: 0.28, intensity: 0.88, control: 0.2, clarity: 0.4),
        ...
        Emotion(name: "Awkward",
                color: ColorData.calculateMoodColor(pleasantness: 0.35, intensity: 0.72) ?? .gray,
                description: "Feeling socially clumsy and uncomfortable, unsure of how to act in a situation.",
                pleasantness: 0.35, intensity: 0.72, control: 0.4, clarity: 0.5),
        ...
        Emotion(name: "Startled",
                color: ColorData.calculateMoodColor(pleasantness: 0.45, intensity: 0.92) ?? .gray,
                description: "A sudden, sharp surprise that triggers a quick, involuntary reaction. A momentary jolt.",
                pleasantness: 0.45, intensity: 0.92, control: 0.2, clarity: 0.95),
        ...
        Emotion(name: "Vigilant",
                color: ColorData.calculateMoodColor(pleasantness: 0.52, intensity: 0.8) ?? .gray,
                description: "On high alert, carefully watchful for potential dangers or difficulties. Focused and ready.",
                pleasantness: 0.52, intensity: 0.8, control: 0.7, clarity: 0.85),
        Emotion(name: "Astonished",
                color: ColorData.calculateMoodColor(pleasantness: 0.55, intensity: 0.85) ?? .gray,
                description: "Overwhelmingly surprised or impressed; filled with a sense of wonder and disbelief.",
                pleasantness: 0.55, intensity: 0.85, control: 0.4, clarity: 0.9),
        ...
        Emotion(name: "Driven",
                color: ColorData.calculateMoodColor(pleasantness: 0.62, intensity: 0.88) ?? .gray,
                description: "Compelled by a deep inner force to pursue a goal with relentless determination and focus.",
                pleasantness: 0.62, intensity: 0.88, control: 0.8, clarity: 0.9),
        ...
        Emotion(name: "Eager",
                color: ColorData.calculateMoodColor(pleasantness: 0.72, intensity: 0.78) ?? .gray,
                description: "Full of keen desire and enthusiastic anticipation to do or have something.",
                pleasantness: 0.72, intensity: 0.78, control: 0.65, clarity: 0.8),
        Emotion(name: "Hyper",
        ...
        Emotion(name: "Passionate",
                color: ColorData.calculateMoodColor(pleasantness: 0.84, intensity: 0.9) ?? .gray,
                description: "Filled with intense, driving, or overmastering feeling and conviction.",
                pleasantness: 0.84, intensity: 0.9, control: 0.65, clarity: 0.8),
        ...
        Emotion(name: "Courageous",
                color: ColorData.calculateMoodColor(pleasantness: 0.87, intensity: 0.82) ?? .gray,
                description: "Feeling brave and ready to face danger, difficulty, or pain with confidence and resolution.",
                pleasantness: 0.87, intensity: 0.82, control: 0.8, clarity: 0.9),
        ...
        Emotion(name: "Triumphant",
                color: ColorData.calculateMoodColor(pleasantness: 0.92, intensity: 0.9) ?? .gray,
                description: "Exulting over a great victory or success; feeling victorious and celebratory.",
                pleasantness: 0.92, intensity: 0.9, control: 0.8, clarity: 0.9),
        Emotion(name: "Jubilant",
                color: ColorData.calculateMoodColor(pleasantness: 0.94, intensity: 0.93) ?? .gray,
                description: "Showing great joy, satisfaction, or triumph; rejoicing.",
                pleasantness: 0.94, intensity: 0.93, control: 0.7, clarity: 0.85),
        ...
        Emotion(name: "Ecstatic",
                color: ColorData.calculateMoodColor(pleasantness: 0.98, intensity: 0.98) ?? .gray,
                description: "Overwhelmed with intense joy and excitement, a feeling of rapturous delight.",
                pleasantness: 0.98, intensity: 0.98, control: 0.75, clarity: 0.85)
    ].sorted { $0.pleasantness < $1.pleasantness }
    ...
    static let mediumEnergyEmotions: [Emotion] = [
        ...
        Emotion(name: "Appalled",
                color: ColorData.calculateMoodColor(pleasantness: 0.15, intensity: 0.65) ?? .gray,
                description: "Feeling horror and consternation; greatly dismayed or horrified by an unpleasant discovery.",
                pleasantness: 0.15, intensity: 0.65, control: 0.3, clarity: 0.8),
        ...
        Emotion(name: "Pessimistic",
                color: ColorData.calculateMoodColor(pleasantness: 0.22, intensity: 0.48) ?? .gray,
                description: "Tending to see the worst aspect of things or believe that the worst will happen.",
                pleasantness: 0.22, intensity: 0.48, control: 0.4, clarity: 0.6),
        Emotion(name: "Guilty",
        ...
        Emotion(name: "Suspicious",
                color: ColorData.calculateMoodColor(pleasantness: 0.28, intensity: 0.58) ?? .gray,
                description: "Having or showing a cautious distrust of someone or something; feeling that something is wrong.",
                pleasantness: 0.28, intensity: 0.58, control: 0.5, clarity: 0.4),
        ...
        Emotion(name: "Hesitant",
                color: ColorData.calculateMoodColor(pleasantness: 0.38, intensity: 0.45) ?? .gray,
                description: "Tentative, unsure, or slow in acting or speaking; feeling a sense of uncertainty.",
                pleasantness: 0.38, intensity: 0.45, control: 0.5, clarity: 0.6),
        ...
        Emotion(name: "Skeptical",
                color: ColorData.calculateMoodColor(pleasantness: 0.42, intensity: 0.48) ?? .gray,
                description: "Not easily convinced; having doubts or reservations about something.",
                pleasantness: 0.42, intensity: 0.48, control: 0.6, clarity: 0.7),
        Emotion(name: "Reserved",
                color: ColorData.calculateMoodColor(pleasantness: 0.45, intensity: 0.4) ?? .gray,
                description: "Slow to reveal emotion or opinions; keeping one's thoughts and feelings to oneself.",
                pleasantness: 0.45, intensity: 0.4, control: 0.8, clarity: 0.7),
        Emotion(name: "Calm",
        ...
        Emotion(name: "Indifferent",
                color: ColorData.calculateMoodColor(pleasantness: 0.52, intensity: 0.42) ?? .gray,
                description: "Having no particular interest or sympathy; unconcerned.",
                pleasantness: 0.52, intensity: 0.42, control: 0.7, clarity: 0.6),
        ...
        Emotion(name: "Curious",
                color: ColorData.calculateMoodColor(pleasantness: 0.58, intensity: 0.52) ?? .gray,
                description: "Eager to know or learn something; possessing a strong desire to investigate and understand.",
                pleasantness: 0.58, intensity: 0.52, control: 0.6, clarity: 0.8),
        ...
        Emotion(name: "Focused",
                color: ColorData.calculateMoodColor(pleasantness: 0.62, intensity: 0.58) ?? .gray,
                description: "Directing a great deal of attention, interest, and activity towards a particular aim.",
                pleasantness: 0.62, intensity: 0.58, control: 0.8, clarity: 0.9),
        ...
        Emotion(name: "Amused",
                color: ColorData.calculateMoodColor(pleasantness: 0.68, intensity: 0.5) ?? .gray,
                description: "Finding something funny or entertaining, causing gentle laughter or a smile.",
                pleasantness: 0.68, intensity: 0.5, control: 0.7, clarity: 0.7),
        ...
        Emotion(name: "Intrigued",
                color: ColorData.calculateMoodColor(pleasantness: 0.72, intensity: 0.55) ?? .gray,
                description: "Arousing one's curiosity or interest; fascinated by something unusual or mysterious.",
                pleasantness: 0.72, intensity: 0.55, control: 0.6, clarity: 0.8),
        ...
        Emotion(name: "Engaged",
                color: ColorData.calculateMoodColor(pleasantness: 0.76, intensity: 0.6) ?? .gray,
                description: "Occupied, absorbed, or involved in an activity with interest and commitment.",
                pleasantness: 0.76, intensity: 0.6, control: 0.75, clarity: 0.85),
        ...
        Emotion(name: "Sympathetic",
                color: ColorData.calculateMoodColor(pleasantness: 0.8, intensity: 0.45) ?? .gray,
                description: "Feeling, showing, or expressing pity and sorrow for someone else's misfortune.",
                pleasantness: 0.8, intensity: 0.45, control: 0.7, clarity: 0.8),
        Emotion(name: "Confident",
                color: ColorData.calculateMoodColor(pleasantness: 0.82, intensity: 0.6) ?? .gray,
                description: "Feeling or showing certainty about something; self-assured and poised.",
                pleasantness: 0.82, intensity: 0.6, control: 0.85, clarity: 0.9),
        Emotion(name: "Optimistic",
                color: ColorData.calculateMoodColor(pleasantness: 0.84, intensity: 0.52) ?? .gray,
                description: "Hopeful and confident about the future; expecting good things to happen.",
                pleasantness: 0.84, intensity: 0.52, control: 0.7, clarity: 0.8),
        ...
        Emotion(name: "Appreciative",
                color: ColorData.calculateMoodColor(pleasantness: 0.88, intensity: 0.48) ?? .gray,
                description: "Feeling or showing gratitude or pleasure for something; recognizing the good qualities of someone or something.",
                pleasantness: 0.88, intensity: 0.48, control: 0.8, clarity: 0.9),
        ...
        Emotion(name: "Touched",
                color: ColorData.calculateMoodColor(pleasantness: 0.92, intensity: 0.45) ?? .gray,
                description: "Feeling a light, heartwarming emotion in response to kindness or beauty.",
                pleasantness: 0.92, intensity: 0.45, control: 0.7, clarity: 0.85)
    ].sorted { $0.pleasantness < $1.pleasantness }
    ...
    static let lowEnergyEmotions: [Emotion] = [
        ...
        Emotion(name: "Defeated",
                color: ColorData.calculateMoodColor(pleasantness: 0.14, intensity: 0.33) ?? .gray,
                description: "Having been beaten in a battle or other contest; feeling a sense of failure and loss of spirit.",
                pleasantness: 0.14, intensity: 0.33, control: 0.2, clarity: 0.5),
        ...
        Emotion(name: "Regretful",
                color: ColorData.calculateMoodColor(pleasantness: 0.24, intensity: 0.39) ?? .gray,
                description: "Feeling sad, repentant, or disappointed over something that has happened or been done.",
                pleasantness: 0.24, intensity: 0.42, control: 0.4, clarity: 0.7),
        ...
        Emotion(name: "Lethargic",
                color: ColorData.calculateMoodColor(pleasantness: 0.28, intensity: 0.22) ?? .gray,
                description: "Feeling a lack of energy and enthusiasm; sluggish and indifferent.",
                pleasantness: 0.28, intensity: 0.22, control: 0.4, clarity: 0.5),
        ...
        Emotion(name: "Resigned",
                color: ColorData.calculateMoodColor(pleasantness: 0.4, intensity: 0.38) ?? .gray,
                description: "Having accepted something unpleasant that one cannot do anything about; submissive.",
                pleasantness: 0.4, intensity: 0.38, control: 0.6, clarity: 0.7),
        Emotion(name: "Pensive",
                color: ColorData.calculateMoodColor(pleasantness: 0.45, intensity: 0.36) ?? .gray,
                description: "Engaged in, involving, or reflecting deep or serious thought. Quietly thoughtful.",
                pleasantness: 0.45, intensity: 0.36, control: 0.7, clarity: 0.8),
        ...
        Emotion(name: "Contemplative",
                color: ColorData.calculateMoodColor(pleasantness: 0.52, intensity: 0.28) ?? .gray,
                description: "Expressing or involving prolonged thought; absorbed in observation or reflection.",
                pleasantness: 0.52, intensity: 0.28, control: 0.8, clarity: 0.9),
        ...
        Emotion(name: "Drowsy",
                color: ColorData.calculateMoodColor(pleasantness: 0.58, intensity: 0.2) ?? .gray,
                description: "Sleepy and lethargic; half asleep. A heavy-lidded state of near-rest.",
                pleasantness: 0.58, intensity: 0.2, control: 0.5, clarity: 0.6),
        Emotion(name: "Nostalgic",
                color: ColorData.calculateMoodColor(pleasantness: 0.6, intensity: 0.35) ?? .gray,
                description: "A sentimental longing or wistful affection for a period in the past.",
                pleasantness: 0.6, intensity: 0.35, control: 0.6, clarity: 0.7),
        Emotion(name: "Secure",
        ...
        Emotion(name: "Placid",
                color: ColorData.calculateMoodColor(pleasantness: 0.7, intensity: 0.25) ?? .gray,
                description: "Not easily upset or excited; calm and peaceful, with little movement or activity.",
                pleasantness: 0.7, intensity: 0.25, control: 0.85, clarity: 0.9),
        ...
        Emotion(name: "Comfy",
                color: ColorData.calculateMoodColor(pleasantness: 0.8, intensity: 0.22) ?? .gray,
                description: "Feeling physically relaxed and comfortable, at ease in your surroundings.",
                pleasantness: 0.8, intensity: 0.22, control: 0.8, clarity: 0.8),
        Emotion(name: "Serene",
        ...
        Emotion(name: "Peaceful",
                color: ColorData.calculateMoodColor(pleasantness: 0.88, intensity: 0.25) ?? .gray,
                description: "Free from disturbance; tranquil. A state of untroubled, quiet, and calm.",
                pleasantness: 0.88, intensity: 0.25, control: 0.9, clarity: 0.9),
        ...
        Emotion(name: "Cozy",
                color: ColorData.calculateMoodColor(pleasantness: 0.92, intensity: 0.2) ?? .gray,
                description: "A feeling of comfort, warmth, and relaxation in a pleasant, snug environment.",
                pleasantness: 0.92, intensity: 0.2, control: 0.85, clarity: 0.8),
        Emotion(name: "Moved",
                color: ColorData.calculateMoodColor(pleasantness: 0.95, intensity: 0.4) ?? .gray,
                description: "Having strong feelings of sadness or sympathy, because of something someone has said or done.",
                pleasantness: 0.95, intensity: 0.4, control: 0.7, clarity: 0.8)
    ].sorted { $0.pleasantness < $1.pleasantness }
}
